...
public class ListaClienteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Cliente clientes = new Cliente(nome, cpf, sexo, data_nasc, numero, cep, rua, bairro, cidade, complemento, celular, telefone, email, true);

        clientes.setId_cliente(Integer.parseInt(id));
