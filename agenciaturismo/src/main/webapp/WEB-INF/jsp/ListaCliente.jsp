            ...
            <tbody>
                <c:forEach var="clientes" items="${encontrados}">
                    <tr >
                        ...
                        <td><a class="btn btn-danger" href="ExcluiClienteServlet?action=delete&id=${clientes.getId_cliente()}&pesquisa=${pesquisa}"/><i class="glyphicon glyphicon-trash">Remover</i></a></td>
