window.onload = function () {
    MaskedInput({
        elm: document.getElementById('telefone'),
        format: '(__)____-____',
        separator: '()-'
    });

    MaskedInput({
        elm: document.getElementById('celular'),
        format: '(__)_____-____',
        separator: '()-'
    });
    ...
    MaskedInput({
        elm: document.getElementById('cep'),
        format: '_____-___',
        separator: '-'
    });
};
